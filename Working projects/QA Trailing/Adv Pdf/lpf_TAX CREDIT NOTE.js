...
if (sub != "") { var address = sub.getFieldValue('mainaddress_text');
...
template+='                                        </style>';
template+='                                    </head>';
template+='                                    <body header="nlheader" background-macro="watermark" header-height="33%" footer="nlfooter" footer-height="4%" padding="0.25in 0.5in 0.25in 0.5in" size="A4">';
template+='<!-- <table style="width:100%">';
template+='            <tr><td align="center" class="title">';
...
template+='                                                        </td>';
template+='                                                         <td align="center" class="td_top_line td_right_line">';
template+='                                                            <p class="alignC">${item.description}</p>';
template+='                                                        </td>';
template+='                                                        <td align="center" class="td_top_line td_right_line">';
...
// template+='                                                        </td>';
template+='                                                        <td align="center" class="td_top_line td_right_line">';
template+='                                                                            <p class="alignC">${item.amount?string("##,#00.00")}</p>';
template+='                                                                        </td>';
template+='                                                                          <td align="center" class="td_top_line td_right_line">';
template+='                                                            <p class="alignC">${item.tax1amt?string("##,#00.00")}</p>';
template+='                                                        </td>';
template+='                                                       <td align="right" class="td_top_line td_right_line">';
...
template+='';
template+='<tr>';
template+='<td align="right" colspan="9" class="td_right_line  td_top_line" style="font-weight: bold;">TOTAL</td>';
template+='                                                                               ';
template+='                                                                                <td align="right" class="td_top_line td_right_line ">';
template+='                                                                                    <p class="alignR">';
...
template+='                                                                                <td align="right" class="td_top_line td_right_line ">';
template+='                                                                                    <p class="alignR">';
template+='                                                                                        <b>${totaltaxamount?string("##,#00.00")}</b>';
template+='                                                                                    </p>';
template+='                                                                                </td>';
template+='                                                                                <td align="right" class="td_top_line td_right_line ">';
template+='                                                                                    <p class="alignR">';
