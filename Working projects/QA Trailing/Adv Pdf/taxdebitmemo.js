...
template+=' <td align="left" width="50%">' +country+ '</td>';
...
template+='                                                    <th align="left" width="15%" class="td_bottom_line">';
template+='                                                        <p align="left">';
template+='                                                            <b>Sr.No.#</b>';
template+='                                                        </p>';
template+='                                                    </th>';
template+='                                                     <th align="left" class="td_bottom_line" width="15%">';
template+='                                                        <p class="alignL">Item Number</p>';
template+='                                                    </th>';
template+='                                                    <th align="left" class="td_bottom_line" width="15%">';
template+='                                                        <p class="alignL">Description</p>';
template+='                                                    </th>';
template+='                                                    <th align="left" class="td_bottom_line" width="15%">';
template+='                                                        <p class="alignL">Quantity Unit</p>';
template+='            ';
template+='                                                    </th>';
...
template+='                                                                                    <p class="alignR">';
template+='                                                                                        <b>${totalamount?string("##,#00.000")}</b>';
template+='                                                                                    </p>';
template+='                                                                                </td>';
template+='                                                                            ';
template+='                                                                                <td align="right" class="td_top_line td_right_line ">';
...
template+='                                                                                <td align="right" class="td_top_line td_right_line ">';
template+='                                                                                    <p class="alignR">';
template+='                                                                                        <b>${totaltaxamount?string("##,#00.000")}</b>';
template+='                                                                                    </p>';
template+='                                                                                </td>';
template+='                                                                                ';
template+='                                                                               ';
...
template+='                                                                                <td align="right" class="td_top_line ">';
template+='                                                                                    <p class="alignR">';
template+='                                                                                        <b>${totalgrossamount?string("##,#00.000")}</b>';
template+='                                                                                    </p>';
template+='                                                                                </td>';
template+='                                                                                ';
template+='                                                                            </tr>-->';
...
template+='                                                        </td>';
template+='                                                        <td align="center" class="">';
template+='                                                            <p class="alignC">${totalamount?string("##,#00.000")}</p>';
template+='                                                        </td>';
// template+='                                                         <td align="center" class="">';
// template+='                                                            <p class="alignC"></p>';
// template+='                                                        </td>';
...
template+='                                                        </td>';
template+='                                                        <td align="right" class="">';
template+='                                                            <p class="alignR">${totaltaxamount?string("#,#0.00")}</p>';
template+='                                                        </td>';
template+='                                                         <td align="right" class="">';
template+='                                                            <p class="alignR">${record.usertotal?string("##,#00.000")}</p>';
template+='                                                        </td>';
template+='  </tr> ';
