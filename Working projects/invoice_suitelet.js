function printNewInvoice(request, response) {
    var invID = request.getParameter("recid");
    var purchRec = nlapiLoadRecord('invoice', 10769);
...
template+='		<td style="border-right:1px solid black;">Invoice no. :280898</td>';
template+='		<td>Invoice Date:10-feb-2021</td>';
template+='	</tr>';
template+='</table>';
template+='	<br>';
template+='	</br>';
...
template+='			<P>Sales Rep: MELWYN DCOSTA </P>';
