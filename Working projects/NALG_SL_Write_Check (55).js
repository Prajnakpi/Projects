        ...
        if (logo != null) {
            ...
            if (subsidiary == "1") {
                template +=
                    ...
                    + "                                            <img src=\"" + logoUrl + "\" style=\"width:155px;height:50px;position:absolute;top:30px;left:38%;\" /> "
                    + "                                        </td> ";
...
+ "if>"
        ...
        + "                                                    <u>WRITE CHECK - PAYMENT VOUCHER</u> "
        + "                                                </td> "
        + "                                            </tr> "
        + "                                        </table> "
        ...
        + "                                                                <b>&nbsp;&nbsp;:&nbsp;&nbsp;</b> "
        + "                                                            </td> "
        + "                                                            <td align=\"left\" width=\"64%\">" +relaceCharector(custAdd)+ "</td> "
        + "                                                        </tr> "
        + " "
        + "                                                        <tr> "
        + "                                                            <td align=\"left\" width=\"30%\"> "
        ...
        + "                                                                <b>&nbsp;&nbsp;:&nbsp;&nbsp;</b> "
        + "                                                            </td> "
        + "                                                            <td align=\"left\" width=\"64%\">${record.custbody_total_amount_3_decimal?string[\"#,##0.000\"]}</td> "
        + "                                                        </tr> "
        + " "
        + "                                                    </table> "
        + "                                                </td> "
        ...
        + "                    <b>Tax Rate</b> "
        + "                </td> "
        + "                <td align=\"center\" width=\"11%\" class=\"td_right_line\"> "
        + "                    <b>Tax Amount</b> "
        + "                </td> "
        ...
        + "            </td> "
        + "            <td align=\"right\" class=\"td_top_line td_right_line\"> "
        + '                <p class=\"alignR\">${item.custcol_amount_3_decimal}</p> '
        + "            </td> "
        + "            <td align=\"right\" class=\"td_top_line td_right_line\"> "
        + '                <p class=\"alignR\">${item.taxrate1}</p> '
        + "            </td> "
        + "            <td align=\"right\" class=\"td_top_line td_right_line\"> "
        + '                <p class=\"alignR\">${item.custcol_tax_amount_3_decimal}</p> '
        + "            </td> "
        + "            <td align=\"right\" class=\"td_top_line\"> "
        + '                <p class=\"alignR\">${item.custcol_gross_amount_3_decimal}</p> '
        + "            </td> "
        + "        </tr> "
        + "        <tr> "
        ...
        + "<table> "
        + "<tr> "
        + "        <td align=\"center\">${record.custbody_created_by}<br/>${record.createddate}</td> "
        + "    </tr> "
        + "    <tr> "
        ...
        + "<table> "
        + "<tr> "
        + "        <td align=\"center\">${record.custpage_approved_by_print}<br/>${record.custpage_approver_print}</td> "
        + "    </tr> "
        + "    <tr> "
        + "        <td align=\"center\" style=\"margin-top:-16px\">___________________</td> "
        + "    </tr> "
