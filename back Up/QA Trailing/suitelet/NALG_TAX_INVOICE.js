function createTaxInvoiceAction(request, response) {
    ...
    template += '         <td width="63%"><p align="left">' + custId + '</p></td>';
    //     }
    // }      
    template += '                    ';
    template += '                    ';
    ...
    if (subsidiary == 3) {
        ...
        template += '                    <td align="right" valign="top" width="33%">';
        template += '<img src="${record.custbody_subsidiary_logo.imageUrl}" style="width:150px;height:150px;margin:100px;position:absolute;top:-50px;padding-top:-100px;padding-left:-110px;"  />  ';
        template += '</td>                 ';
    ...
    if (entityParent) {
        ...
        template += '                    <td width="63%"><p align="left">' + parentId + '</p></td>';
        template += '                </tr>';
        template += '                <tr>';
        ...
        template += '                    <td><p align="left"><b>Address</b></p></td>';
        template += '                    <td ><b>:</b></td>';
        template += '                    <td><p align="left">' + parentaddress + '</p></td>';
        template += '                </tr>';
    ...
    template += '                                        </style>';
    template += '                                    </head>';
    template += '                                    <body header="nlheader" background-macro="watermark" header-height="35%" footer="nlfooter" footer-height="4%" padding="0.25in 0.5in 0.25in 0.5in" size="A4">';
    var amountTotal = 0;
    ...
    template += '                </tr> -->';
    template += '                <tr>';
    template += '                    <td width="40%"><p align="left"><b>Invoice No</b></p></td>';
    template += '                    <td width="2%"><b>:</b></td>';
    template += '                    <td width="45%"><p align="left">${record.tranid}</p></td>';
    template += '                </tr>';
    template += '                <tr>';
    ...
    template += '                    <td ><b>:</b></td>';
    template += '                    <td><p align="left">${record.duedate?string("dd-MMM-YYYY")}</p></td>';
    template += '                </tr>';
    template += '                <tr>';
    ...
    if (createdFrom) {
        ...
        var rectype = nlapiLookupField('transaction', salesRecId, 'recordtype');
         nlapiLogExecution('Debug', 'Transaction', 'Type : ' + rectype);
         var salesRec = nlapiLoadRecord(rectype, salesRecId);
         shippeddate = salesRec.getFieldValue("shippeddate")
    ...
    template += '                                                    </th>';
    template += '                                                    <th align="left" class="td_right_line" width="18%">';
    template += '                                                        <p class="alignL">Goods/Service Description</p>';
    template += '                                                    </th>';
    template += '                                                    <th align="center" class="td_right_line" width="6%">';
    template += '                                                        <p>Qty</p>';
    template += '                                                    </th>';
    template += '                                                    <th align="center" class="td_right_line" width="8%">';
    template += '                                                        <p>Units</p>';
    template += '                                                    </th>';
    template += '                                                   ';
    ...
    template += '                                                    </th>';
    template += '                                                     <th align="right" width="10%">';
    ...
    for (var i = 1; i <= count; i++) {
        var itemtype = taxRec.getLineItemValue('item', 'itemtype', i);
        ...
        if (itemtype != "Discount") {
            ...
            var discounttaxamount = taxRec.getLineItemValue('item', 'tax1amt', j);
            var discountgrossamount = taxRec.getLineItemValue('item', 'grossamt', j);
            ...
            template += '<td align="center" class="td_top_line td_right_line">';
            template += '                                                            <p class="alignC">' + relaceCharector(itemNo) + '</p>';
            template += '                                                        </td>';
            if (barcode != null) {

                template += '                                                         <td align="center" class="td_top_line td_right_line">';
                template += '                                                            <p class="alignC">' + barcode + '</p>';
                template += '                                                        </td>';
            } else {
                template += '                                                         <td align="center" class="td_top_line td_right_line">';
            ...
            if (goodsanddelivery != null) {
                template += '                                                         <td align="center" class="td_top_line td_right_line">';
                template += '                                                            <p class="alignC">' + goodsanddelivery + '</p>';
                template += '                                                        </td>';
            } else {
                template += '                                                         <td align="center" class="td_top_line td_right_line">';
                template += '                                                            <p class="alignC"></p>';
            ...
            if (discountamount != null) {
                ...
                template += '                                                             <td align="center" class="td_top_line td_right_line">';
                template += '                                                            <p class="alignC">' + discountamount + '</p>';
                template += '                                                        </td>';
            } else {
                template += '                                                         <td align="center" class="td_top_line td_right_line">';
                template += '                                                            <p class="alignC"></p>';
            ...
            template += '                                                                        </td>';
            template += '                                                                          <td align="center" class="td_top_line td_right_line">';
            template += '                                                            <p class="alignC">' + taxtotalAmount + '</p>';
            template += '                                                        </td>';
            template += '                                                       <td align="right" class="td_top_line td_right_line">';
            ...
            template += '                                                                                <#assign totalgrossamount=totalgrossamount + item.grossamt/>' + grossAmount + '</p>';
    ...
    template += '                                                                                <td align="right" class="td_top_line td_right_line ">';
    template += '                                                                                    <p class="alignR">';
    template += '                                                                                        <b>' + TotalTaxableAmount + '</b>';
    template += '                                                                                    </p>';
    template += '                                                                                </td>';
    template += '                                                                                <td align="right" class="td_top_line td_right_line ">';
    template += '                                                                                    <p class="alignR">';
    template += '                                                                                        <b>' + TaxAmountTotal + '</b>';
    template += '                                                                                    </p>';
    template += '                                                                                </td>';
    template += '                                                                                <td align="right" class="td_top_line td_right_line ">';
    template += '                                                                                    <p class="alignR">';
    ...
    template += '';
    template += '        <td align="left" style="width:73%;">1.GOODS ARE RECEIVED IN GOOD CONDITION<br/>2.ANY RETURN OF GOODS AFTER 24 HOURS IS SUBJECT TO MANAGEMENT APPROVAL<br/>3.NO CORRECTION/ALTERNATIONS ON TAX INVOICE<br/>4.PAYMENT SHOULD BE MADE BY A/C PAYEE CHEQUE ONLY IN FAVOUR OF OUR COMPANY<br/>5.ANY DISPUTE WILL BE SETTLED AS PER USE LAW<br/>6.EOE</td>';
    template += '';
    template += '                                                                    </tr>';
    template += '';
    template += '                                                                    </table>';
    ...
    template += '    <tr>';
    template += '';
    template += '        <td align="left" colspan="2">Account Name &nbsp;:&nbsp;${record.custbody_bank_account.custrecord_account_name}</td>';
    template += '';
    template += '    </tr>';
    template += '';
    template += '    <tr>';
    template += '';
    template += '        <td align="left" colspan="2">Account Number &nbsp;:&nbsp;${record.custbody_bank_account.custrecord_ac_number}</td>';
    template += '';
    template += '    </tr>';
    template += '';
    template += '    <tr>';
